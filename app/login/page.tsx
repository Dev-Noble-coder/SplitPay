...
import { ArrowLeft, Sms, Lock1, EyeSlash, Google } from "iconsax-react";
      ...
      <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
        <div className="relative">
          ...
          <div className="relative flex items-center border-b border-gray-300 focus-within:border-primary pb-2 transition-colors">
            <input 
              type="email" 
              className="w-full outline-none text-gray-900 placeholder-gray-400 text-base"
        ...
        <div className="relative">
          ...
          <div className="relative flex items-center border-b border-gray-300 focus-within:border-primary pb-2 transition-colors">
            ...
            />
            <button type="button" className="absolute right-0 text-gray-400 hover:text-gray-600">
              <EyeSlash size="20" />
            </button>
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <Link href="/reset-password" className="text-sm text-primary font-medium">
            Forgot Password?
          </Link>
        </div>
